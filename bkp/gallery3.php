...
<div class = "photos" id="photos">
    ...
    <div class="col-md-5ths col-sm-6 col-xs-12 photoElement">
        <a href = "index.php?fn=<?php echo $photo['filename'] ?>" class = "photoBox">
            <img class="lazyload"  data-src = "<?php echo $cdnurl.$photo['filename'] ?>" class="img-responsive" alt="" style = "width: 100%">
                <div class="photo-box-caption">
                    <div class="photo-box-caption-content"><?php echo $photo['show_date'] ?>
                    </div>
                </div>
        </a>
    </div>
